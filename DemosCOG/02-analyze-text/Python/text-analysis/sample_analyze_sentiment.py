...
def sample_analyze_sentiment() -> None:
    ...
    endpoint = "https://azailanguagebauer102.cognitiveservices.azure.com/"
    key = "8sXSxQ5avIE9oGEqgWnPqzaFm70SEhiB9MqdyFwJvGFrSLkP9ALMJQQJ99BKACYeBjFXJ3w3AAAaACOGM5an"

    text_analytics_client = TextAnalyticsClient(endpoint=endpoint, credential=AzureKeyCredential(key))

    documents = [
        """Hoje o dia foi maravilhoso, com muitas alegrias, com várias boas surpresas e sem nenhum estresse"""
    ]
